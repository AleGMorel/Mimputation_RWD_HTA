...
M25_HL1 <- read_excel("~/HTA PhD/Missing Data Simulation/R codes/Time to Get Real/Data/HY_HC/MISSING25/M25_HL1.xlsx")

#Defining data
cost <- M25_HL1$cost
cost_miss <- M25_HL1$cost_miss
Y <- M25_HL1$Y
Y_miss <- M25_HL1$Y_miss
