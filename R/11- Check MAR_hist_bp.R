...
M10_HL10 <- read_excel("~/HTA PhD/Missing Data Simulation/R codes/Time to Get Real/Data/HY_HC/MISSING10/M10_HL10.xlsx")

#Defining data
cost <- M10_HL10$cost
cost_miss <- M10_HL10$cost_miss
Y <- M10_HL10$Y
Y_miss <- M10_HL10$Y_miss
