###### Introduce missings at 25% in HY_HC complete datasets######
...
MISSING25 <- function(ds){
  ...
  missing_p_Y <- inv_logit(-5.15 + 0.01*ds$rom + 0.02*ds$age + 0.02*ds$depression) # probability of missing in outcome
  missing_p_cost <- inv_logit(-4.15 + 0.01*ds$rom + 0.02*ds$age + 0.02*ds$depression) #probability of missing in costs
